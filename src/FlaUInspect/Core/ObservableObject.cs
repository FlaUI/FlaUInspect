...
public abstract class ObservableObject : INotifyPropertyChanged {
	...
	protected virtual void OnPropertyChanged<T>(Expression<Func<T>> selectorExpression) => PropertyChanged?.Invoke(this, new PropertyChangedEventArgs((selectorExpression.Body as MemberExpression)?.Member.Name));
	...
	public void RaisePropertyChanged([CallerMemberName] string? propertyName = null) => RaisePropertyChanged(new PropertyChangedEventArgs(propertyName));
